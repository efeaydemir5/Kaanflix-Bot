...
exports.run = (client, message, args) => {
  ...
  if (reason.length < 1) return message.reply('3. uyarma sebebini yazmalısın.').catch(console.error);
  if (message.mentions.users.size < 1) return message.reply('Kimi 3, kez uyaracağımı yazmalısın.').catch(console.error);
  const embed = new Discord.RichEmbed()
    .setColor(0x00AE86)
    .setTimestamp()
    .addField('Eylem:', '3. uyarma')
...
exports.help = {
  name: 'uyar 3',
  description: 'İstediğiniz kişiyi  uyarır 3.',
